...
namespace STEM107.Main.AdvancedControlsOverlay
{
    ...
    /// </summary>
    public partial interface IAdvPowerByItem
    {
        /// <summary>
        ...
        /// <summary>
        /// Main.AdvancedControlsOverlay.Tab1._Selected Feedback
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the feedback.</param>
        void Tab_Selected(ushort buttonIndex, AdvPowerBoolInputSigDelegate callback);

        /// <summary>
        /// Helper Main.AdvancedControlsOverlay.Tab1._Selected Feedback
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
    ...
    /// Search List
    /// </summary>
    internal partial class AdvPower
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, AdvPowerBoolInputSigDelegate callback)
        {
    ...
    /// Adv-Power
    /// </summary>
    public partial interface IAdvPower : IAdvPowerByItem
    {
        object UserObject { get; set; }

        /// <summary>
        /// Event Main.AdvancedControlsOverlay.Tab1._Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Tab_1_Item_PressEvent;

        /// <summary>
        /// Event Main.AdvancedControlsOverlay.Tab2._Press (from panel to Control System)
        /// </summary>
        ...
        void Tab_1_Item_Selected(AdvPowerBoolInputSigDelegate callback);
        ...
        /// <summary>
        /// Main.AdvancedControlsOverlay.Tab2._Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(AdvPowerBoolInputSigDelegate callback);
    ...
    /// <param name="advpower">The <see cref="IAdvPower"/> on which to apply the feedback.</param>
    public delegate void AdvPowerBoolInputSigDelegate(BoolInputSig boolInputSig, IAdvPower advpower);

    /// <summary>
    /// Adv-Power
    /// </summary>
    internal partial class AdvPower : IAdvPower, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.AdvancedControlsOverlay.AdvPower.Tab1_Press
                /// Main.AdvancedControlsOverlay.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.AdvancedControlsOverlay.AdvPower.Tab2_Press
                /// Main.AdvancedControlsOverlay.Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.AdvancedControlsOverlay.AdvPower.Tab1_Selected
                /// Main.AdvancedControlsOverlay.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.AdvancedControlsOverlay.AdvPower.Tab2_Selected
                /// Main.AdvancedControlsOverlay.Tab2._Selected
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvPower"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal AdvPower(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal AdvPower(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(AdvPowerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(AdvPowerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "AdvPower", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
