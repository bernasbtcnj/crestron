...
namespace STEM107.Main.ControlsDocCamera
{
    ...
    /// </summary>
    public partial interface IDocCamZoomBtnsByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort buttonIndex, DocCamZoomBtnsBoolInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class DocCamZoomBtns
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, DocCamZoomBtnsBoolInputSigDelegate callback)
        {
    ...
    /// DocCam-Zoom-Btns
    /// </summary>
    public partial interface IDocCamZoomBtns : IDocCamZoomBtnsByItem
    {
        ...
        void Tab_1_Item_Selected(DocCamZoomBtnsBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(DocCamZoomBtnsBoolInputSigDelegate callback);
    ...
    /// <param name="doccamzoombtns">The <see cref="IDocCamZoomBtns"/> on which to apply the feedback.</param>
    public delegate void DocCamZoomBtnsBoolInputSigDelegate(BoolInputSig boolInputSig, IDocCamZoomBtns doccamzoombtns);

    /// <summary>
    /// DocCam-Zoom-Btns
    /// </summary>
    internal partial class DocCamZoomBtns : IDocCamZoomBtns, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.ControlsDocCamera.DocCamZoomBtns.Tab1_Press
                /// Main.ControlsDocCamera.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.ControlsDocCamera.DocCamZoomBtns.Tab2_Press
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.ControlsDocCamera.DocCamZoomBtns.Tab1_Selected
                /// Main.ControlsDocCamera.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.ControlsDocCamera.DocCamZoomBtns.Tab2_Selected
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocCamZoomBtns"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal DocCamZoomBtns(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal DocCamZoomBtns(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(DocCamZoomBtnsBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(DocCamZoomBtnsBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "DocCamZoomBtns", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
