...
namespace STEM107.Main.SourceSelect
{
    ...
    /// </summary>
    public partial interface IDisp1SourceSelectByItem
    {
        /// <summary>
        ...
        void Button_Selected(ushort buttonIndex, Disp1SourceSelectBoolInputSigDelegate callback);
        ...
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the feedback.</param>
        void Button_Text(ushort buttonIndex, Disp1SourceSelectStringInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class Disp1SourceSelect
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Button_Selected(ushort buttonIndex, Disp1SourceSelectBoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void Button_Text(ushort buttonIndex, Disp1SourceSelectStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
    ...
    /// Disp1-Source-Select
    /// </summary>
    public partial interface IDisp1SourceSelect : IDisp1SourceSelectByItem
    {
        ...
        void Button_1_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_2_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_3_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_4_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback);
        ...
        void Button_1_Button_Text(Disp1SourceSelectStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_2_Button_Text(Disp1SourceSelectStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_3_Button_Text(Disp1SourceSelectStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_Text(Disp1SourceSelectStringInputSigDelegate callback);
    ...
    /// <param name="disp1sourceselect">The <see cref="IDisp1SourceSelect"/> on which to apply the feedback.</param>
    public delegate void Disp1SourceSelectBoolInputSigDelegate(BoolInputSig boolInputSig, IDisp1SourceSelect disp1sourceselect);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="stringInputSig">The <see cref="StringInputSig"/> joinInfo data.</param>
    /// <param name="disp1sourceselect">The <see cref="IDisp1SourceSelect"/> on which to apply the feedback.</param>
    public delegate void Disp1SourceSelectStringInputSigDelegate(StringInputSig stringInputSig, IDisp1SourceSelect disp1sourceselect);

    /// <summary>
    /// Disp1-Source-Select
    /// </summary>
    internal partial class Disp1SourceSelect : IDisp1SourceSelect, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.SourceSelect.Disp1SourceSelect.Button1ItemPress
                /// Main.SourceSelect.Button1.ItemPress
                /// </summary>
                public const uint Button_1_Button_PressEvent = 1001;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.SourceSelect.Disp1SourceSelect.Button2ItemPress
                /// Main.SourceSelect.Button2.ItemPress
                /// </summary>
                public const uint Button_2_Button_PressEvent = 1002;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.SourceSelect.Disp1SourceSelect.Button3ItemPress
                /// Main.SourceSelect.Button3.ItemPress
                /// </summary>
                public const uint Button_3_Button_PressEvent = 1003;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.SourceSelect.Disp1SourceSelect.Button4ItemPress
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button1ItemSelected
                /// Main.SourceSelect.Button1.ItemSelected
                /// </summary>
                public const uint Button_1_Button_SelectedState = 1001;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button2ItemSelected
                /// Main.SourceSelect.Button2.ItemSelected
                /// </summary>
                public const uint Button_2_Button_SelectedState = 1002;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button3ItemSelected
                /// Main.SourceSelect.Button3.ItemSelected
                /// </summary>
                public const uint Button_3_Button_SelectedState = 1003;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button4ItemSelected
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button1Text
                /// Main.SourceSelect.Button1.Text
                /// </summary>
                public const uint Button_1_Button_TextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button2Text
                /// Main.SourceSelect.Button2.Text
                /// </summary>
                public const uint Button_2_Button_TextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button3Text
                /// Main.SourceSelect.Button3.Text
                /// </summary>
                public const uint Button_3_Button_TextState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Main.SourceSelect.Disp1SourceSelect.Button4Text
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Disp1SourceSelect"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal Disp1SourceSelect(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal Disp1SourceSelect(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Selected(Disp1SourceSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Text(Disp1SourceSelectStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Text(Disp1SourceSelectStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Text(Disp1SourceSelectStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Text(Disp1SourceSelectStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "Disp1SourceSelect", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
